...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li>
                ...
                <button type="button" class="btn-sm btn-register btn-flat" onclick="window.location.href='<?php echo URL; ?>home/clienteform'">
    ...
    <section class="content container-fluid">
        ...
        <?php elseif (isset($_GET['add']) && $_GET['add'] == 'true') : ?>
            <?php echo "<script>$(function () {toastr['warning']('Cadastre o cliente, utilizando o botão cadastrar ao lado.')}); </script>"; ?>
                    ...
                    <tbody>
                        <?php foreach ($clientes as $c) : ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn-sm btn-info btn-flat" href="<?php echo URL; ?>home/vercliente/<?php echo $c->intClienteID; ?>" title="Visualizar Cliente">Visualizar</a>
                                    <a class="btn-sm bg-orange btn-flat" href="<?php echo URL; ?>home/clienteform/<?php echo $c->intClienteID; ?>" title="Editar Cliente">Editar</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
